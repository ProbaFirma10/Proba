...
namespace PatientWebApplicationTests
{
    public class PatientRegistrationTests 
    {
        ...
        public void Create_Registration_Successfuly()
        {
            ...
            PatientUser patient =  service.Create(new PatientDto("ZIKA", "MIkic", "Male", "1234", "11/11/2000", "1231412", "21312312", "PAJA", "Grad", "email@gmail.com", "pass", false, "Grad2", "Roditelj", "", ""));
